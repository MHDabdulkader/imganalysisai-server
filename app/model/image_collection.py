...
class ImageCollection(Base):
    ...
    prompt: Mapped[str] = mapped_column(Text, nullable=False) # TODO maybe limit of prompt length add
    ...
    image_version: Mapped[list["ImageVersion"]] = relationship("ImageVersion", back_populates="collection", cascade="all, delete-orphan")
